...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelShowImg.setPixmap(QtGui.QPixmap(":/newPrefix/name.png"))
        self.labelShowImg.setScaledContents(True)
        ...
        self.labelResponce = QtWidgets.QLabel(self.centralwidget,wordWrap=True)
